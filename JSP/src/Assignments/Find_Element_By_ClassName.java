...
public class Find_Element_By_ClassName {
	public static void main(String[] args) {
		...
		driver.findElement(By.className("svg-region"));
		...
		driver.findElement(By.className("notranslate"));
		System.out.println("element 4 identified");
		
		driver.get("https://www.flipkart.com");
		driver.findElement(By.className("_1kfTjk"));
		System.out.println("element 5 identified");
		
		driver.get("https://www.instagram.com");
		driver.findElement(By.className("_a3wf _-kb segoe"));
		System.out.println("element 6 identified");
		
		driver.get("https://www.ajio.com/");
		driver.findElement(By.className("regular-store"));
		System.out.println("element 7 identified");
		
		driver.get("https://www.thejaipurdialogues.com/");
		driver.findElement(By.className("td-scroll-up"));
